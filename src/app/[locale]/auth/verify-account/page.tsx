    ...
    return (
        ...
        >
            ...
            <div className="w-full md:w-4/5 lg:w-3/5 space-y-8 flex flex-col justify-center items-center">
                ...
                <InputOTP maxLength={6} className="w-full" onComplete={()=>router.push('/dashboard')}>
                ...
                <Button variant="link" className="p-0 h-auto text-neutral-900" size="lg" onClick={() => router.push('/auth/2-step-verification')}><ArrowLeft size={15} /> Back</Button>
            </div>
        </div>
    )
}
