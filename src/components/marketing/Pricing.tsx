...
const Pricing = () => {
    return (
        <section className="max-w-7xl mx-auto px-4 flex flex-col justify-center items-center">
            ...
            <h3 className="text-3xl leading-10 md:text-5xl md:leading-12 font-bold mb-3 text-center  bg-[radial-gradient(70.71%_70.71%_at_50%_50%,_#FFFFFF_0%,_#B5CFFF_56%)] bg-clip-text text-transparent">
