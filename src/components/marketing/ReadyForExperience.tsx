    ...
    return (
        <section className="w-full px-4 py-8 max-w-7xl mx-auto rounded-3xl flex justify-center items-center bg-transparent relative overflow-hidden">
            ...
            <div className="flex-1 flex flex-col items-center justify-center space-y-6 text-center">
                ...
                // Responsive logo size
                />
                <h3 className="text-3xl leading-10 md:text-5xl md:leading-12 font-bold mb-3 bg-[linear-gradient(180deg,_#FFFFFF_0%,_#AD6EFF_100%)] bg-clip-text text-transparent">
