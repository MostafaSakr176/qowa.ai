...
// Add error prop to SelectTrigger
...
// Add label and labelClassName to SelectProps
...
function Select({
  ...
  const inputId = id || (label ? `select-${Math.random().toString(36).substr(2, 9)}` : undefined)
  ...
  return (
    <div className="w-full">
      ...
      <SelectPrimitive.Root data-slot="select" {...props}>
        {/* 
          We want to pass the id to the trigger for accessibility.
          The user should pass <SelectTrigger id={inputId} ... /> as a child,
          or we can try to inject it, but for now, document that id is available.
        */}
        {props.children}
